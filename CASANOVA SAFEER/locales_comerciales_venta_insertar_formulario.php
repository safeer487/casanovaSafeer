...
if (!$_POST) {
	header('Location: locales_comerciales_venta_insertar.php');
	exit;
}
...
$sSQL = "INSERT INTO inmuebles_comerciales VALUES (NULL,'$sTitulo','$sDescripcion','$destino','$sPrecio','$destino1',	'$destino2','$destino3','$destino4','$destino5',
