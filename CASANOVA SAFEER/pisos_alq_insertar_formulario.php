...
if (!$_POST) {
	header('Location: pisos_alq_insertar.php');
	exit;
}
...
$sSQL = "INSERT INTO pisos_alquiler VALUES (NULL,'$sTitulo','$sDescripcion','$destino','$sPrecio','$destino1',	'$destino2','$destino3','$destino4','$destino5',
			'$destino6','$destino7','$destino8','$destino9','$destino10','$sMetro','$sLocalidad','$sAccMinus','$sGarajeIncl','$sAltura','$sAscensor','$sBalcon','$sEdadFinc','$sCertEnerg','$sMapa','$iHabitaciones','$sTerraza','$sDescripcion_ficha_mini','$sExtras_1','$sExtras_2','$sExtras_3','$sExtras_4','$sExtras_5','$sExtras_6','$sExtras_7','$sExtras_8');";
