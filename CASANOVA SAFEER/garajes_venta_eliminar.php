  ...
  <tr>
    ...
    <td>
		...
		<div class="envuelve_titulo_gestion_elimina">
			...
			<h2>GARAJES VENTA<br> ELIMINAR UN ANUNCIO</h2>
		</div>
	<div class="divbuscarModificar">
		<br>
		<h4>BUSCAR POR REFERENCIA</h4>
		<form action="garajes_venta_eliminar.php" method="get">
...
<table id="tablaresultadosInserta">
		...
		$sSQL = "SELECT titulo,descripcion,foto_ficha,img_1,img_2,img_3,img_4,img_5,img_6,img_7,img_8,img_9,img_10,id_ref,precio,metros,localidad,acceso_minusvalido,garaje_incluido,altura,ascensor,balcon,edad_finca,certificado_energetico,mapa,habitaciones,terraza FROM garajes WHERE id_ref = '$iBuscar';";
	...
	echo '	<td class="divResultminiElimina">
				...
				?>		<form action="garajes_venta_eliminar_formulario.php" method="post" >
