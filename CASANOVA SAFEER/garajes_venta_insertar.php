...
<div class="envuelve_titulo_gestion">
			...
			<h2 id="titulo_insertar">GARAJES EN VENTA <br>
...
<table id="tablaInsertar">
  <tr>
    <td>
    	...
    	<form action="garajes_venta_insertar_formulario.php" method="post" enctype="multipart/form-data"> 
