...
<div class="box_Galeria">
	...
	<div class="marcador" style="img/marcador.png"></div>

		<h3 style="margin-left:60px;font-family: CaviarDreams,arial;">...Encuentre aqui el inmueble que 
			busca...</h3><div class="encuentre"></div> 
				...
				<section class="main clearfix">
					...
					<div class="fleft">
						<select id="cd-dropdown" name="filtroTipoInmueble" class="cd-select">
							<option value="pisos_venta" selected>VIVIENDAS (PISOS,CASAS,ETC)</option>
							<option value="inmuebles_comerciales">LOCALES COMERCIALES</option>
		...
		<div style="width:310px;margin:-40px auto 0px 0px;float:left;">
			<section class="main clearfix">
				<div class="fleft">
					...
					<option value="9999999999">MOSTRAR TODOS</option>
					</select>
				</div>
			</section>
		</div>
...
if (isset($_GET['preciomaximo']) && $_GET['preciomaximo'] > 0){
...
if (isset($_GET['preciomaximo'])) {
		...
		echo '	
				...
				?>		<form action="ficha_venta.php" method="post">
