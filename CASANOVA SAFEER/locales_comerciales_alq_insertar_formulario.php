...
if (!$_POST) {
	header('Location: locales_comerciales_alq_insertar.php');
	exit;
}
...
if ($_FILES['archivo']['size'] < $max_size) {
	...
	$destino = "img/foto_ficha/" .  time() . trim($_FILES['archivo']['name']);
...
if ($_FILES['archivo1']['size'] < $max_size) {
	...
	$destino1 = "img/img_galeria/insertadasimg_galeria/insertadas" .  time() . trim($_FILES['archivo1']['name']);
...
if ($_FILES['archivo2']['size'] < $max_size) {
	...
	$destino2 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo2']['name']);
...
if ($_FILES['archivo3']['size'] < $max_size) {
	...
	$destino3 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo3']['name']);
...
if ($_FILES['archivo4']['size'] < $max_size) {
	...
	$destino4 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo4']['name']);
...
if ($_FILES['archivo5']['size'] < $max_size) {
	...
	$destino5 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo5']['name']);
...
if ($_FILES['archivo6']['size'] < $max_size) {
	...
	$destino6 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo6']['name']);
...
if ($_FILES['archivo7']['size'] < $max_size) {
	...
	$destino7 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo7']['name']);
...
if ($_FILES['archivo8']['size'] < $max_size) {
	...
	$destino8 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo8']['name']);
...
if ($_FILES['archivo9']['size'] < $max_size) {
	...
	$destino9 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo9']['name']);
...
if ($_FILES['archivo10']['size'] < $max_size) {
	...
	$destino10 = "img/img_galeria/insertadas" .  time() . trim($_FILES['archivo10']['name']);
...
$sSQL = "INSERT INTO inmuebles_comerciales_alquiler VALUES (NULL,'$sTitulo','$sDescripcion','$destino','$sPrecio','$destino1',	'$destino2','$destino3','$destino4','$destino5',
