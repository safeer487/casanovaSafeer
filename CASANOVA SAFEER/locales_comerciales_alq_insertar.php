  ...
  <tr>
    ...
    <td>
		...
		<div class="envuelve_titulo_gestion">
			...
			<h2 id="titulo_insertar">LOCALES COMERCIALES EN ALQUILER <br> INSERTAR UN ANUNCIO</h2>
		</div>
...
<table id="tablaInsertar">
  <tr>
    <td>
    	...
    	<form action="locales_comerciales_alq_insertar_formulario.php" method="post" enctype="multipart/form-data">  
