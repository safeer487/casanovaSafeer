...
<table id="tabla_textoyMapa">
  <tr >    
	 <td colspan="2" rowspan="2" style="padding-left:10px;padding-right:10px;" height="130px;>
					...
					<div id="tituloFicha_detras">
						<div id="tituloFicha">' . $Array['titulo'] . '<br></div>
					</div>
  ...
  <tr>
    <td height="66" colspan="2" style="color:#66ccff;padding:5px 10px 10px 10px;opacity:0.8;" widht="400">
  ...
  <tr>
    <td style="background-color: #66ccff;padding:5px 10px 0px 10px;color:white;text-align:center;line-height:20px;"> Garaje 
</td>
