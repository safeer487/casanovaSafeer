...
<table id="tablaModificar">
  <tr>
    <td>
    	<form action="pisos_venta_modificar_formulario.php" method="post" >

		
		<p id="titulo_inmu_ref">Inmueble con Referencia Nº<?php  echo $sId_ref ?>
		
		<input type="text" name="idref" id="input_referencia" required value="<?php  echo $sId_ref ?>">
		 </p>    
...
<table id="tabla_Galeria_modificar_1">
  <tr>
	...
	<div style="margin-left:55px;">
 	...
 	<form action="pisos_venta_modificar_formulario_img.php" method="post" enctype="multipart/form-data">  
...
<table id="tabla_Galeria_modificar_2">
  <tr>
     <td style="border-right:20px solid #666666">
    	<form action="pisos_venta_modificar_formulario_img_1.php" method="post" enctype="multipart/form-data">
    ...
    <td style="border-left:20px solid #666666">
		<form action="pisos_venta_modificar_formulario_img_2.php" method="post" enctype="multipart/form-data">
 ...
 <tr>  
    <td style="border-right:20px solid #666666">
		<form action="pisos_venta_modificar_formulario_img_3.php" method="post" enctype="multipart/form-data">
	    ...
	    <td style="border-left:20px solid #666666" >
			<form action="pisos_venta_modificar_formulario_img_4.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
	    ...
	    <td style="border-right:20px solid #666666">
		<form action="pisos_venta_modificar_formulario_img_5.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
	    ...
	    <td style="border-left:20px solid #666666">
	    	<form action="pisos_venta_modificar_formulario_img_6.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
...
<tr>	    
	    <td style="border-right:20px solid #666666">
	    	<form action="pisos_venta_modificar_formulario_img_7.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
	    ...
	    <td style="border-left:20px solid #666666">
	    	<form action="pisos_venta_modificar_formulario_img_8.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
...
<tr>	
	    <td style="border-right:20px solid #666666">
			<form action="pisos_venta_modificar_formulario_img_9.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
	    ...
	    <td style="border-left:20px solid #666666">
			<form action="pisos_venta_modificar_formulario_img_10.php" method="post" enctype="multipart/form-data">
		<div id="invisible_3"></div>
			<input type="text" name="idref" id="input_referencia" value="<?php  echo $sId_ref ?>">
