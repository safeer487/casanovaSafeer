...
<div class="general_Modificar_venta_pisos">
	<div class="boxIntranetModificar">
		...
		<div class="divbuscarModificar">
			...
			<form action="pisos_venta_modificar_formulario_ingresa_datos.php" method="get">
				<input type="text" placeholder="NUMERO de referencia" required name="buscar" id="input_buscar"><br>
