  ...
  <tr>
    ...
    <td>
		...
		<div class="envuelve_titulo_gestion">
			...
			<h2 id="titulo_insertar">VIVIENDAS/PISOS EN ALQUILER <br> INSERTAR UN ANUNCIO</h2>
		</div>
...
<table id="tablaInsertar">
  <tr>
    <td>
    	...
    	<form action="pisos_alq_insertar_formulario.php" method="post" enctype="multipart/form-data"> 
			
			<input type="file" id="archivo" name="archivo"/> 
			<input type="hidden" name="MAX_FILE_SIZE" value="2097152"/> <br>
			(No mas de 200 kb en lo posible	en formato para web )<br>
			(editado con las medidas 290px(pixeles) de ancho por 300 px(pixeles) de alto )<br>
...
<br>
  ...
  <tr>
    <td colspan="2" id="tdGaleria">
		<h3 id="tituloGaleria">GALERIA</h3>
			<br>
